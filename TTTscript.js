...
// let winnerSound = new music("Winner clapping.mp3")
// let turnChangeSound = new music("Tap Sound.mp3")
// let gameOverSound = new music("Game Over sound.mp3")
let turn = "X"
let gameOver = false;
